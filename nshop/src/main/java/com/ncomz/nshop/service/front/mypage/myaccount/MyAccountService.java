package com.ncomz.nshop.service.front.mypage.myaccount;
...
public class MyAccountService {
	...
	public String modifyPassword(MyPage myPage) {
		...
		try {
			SessionUser sessionUser = loginMapper.loginfront(myPage.getUsrId(), SHA256Util.getEncrypt(myPage.getCurrentPwd()));
	...
	public String updateMemberAction(User user) {
		String resultMsg = "";
		System.out.println("AAAAAAAA +"+myPageMapper.updateMemberInfo(user));
		try {
