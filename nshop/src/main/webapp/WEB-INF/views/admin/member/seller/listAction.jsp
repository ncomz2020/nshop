	...
	function deletemember(usr_id){
		swal({
	        ...
	        closeOnConfirm: false
	        	 ...
	        	 $.ajax({
	 			    url:  '/admin/member/seller/deleteAction.ajax',
	 			    async:false,
	 		 	    type: 'POST',
	 			    data: {'usr_id': usr_id},
...
<div class="rowBox mgT30">
	<div class="g_column w_1_1">
		<h3>
			<span class="title"><spring:message code="label.member.management.seller.list"/>
			...
			<table class="amb_table">
				...
				<thead>
					<tr>
						...
						<th rowspan="2"><spring:message code="label.store.name"/></th>
				...
				<tbody>
					<c:forEach items="${user}" var="info" varStatus="status">
						<tr>
							...
							<td colspan="2">
							<a href="javascript:openModal('/admin/member/seller/sellerPopup.ajax' , 'sellerPopup' ,'usr_id=${info.usr_id}' , '600'); " class="amb_btnstyle green middle"><spring:message code="label.common.inquiry"/></a>
					...
					<c:if test="${empty user}">
						<tr>
							<td colspan="11"><spring:message code="label.common.empty.list"/></td>
						</tr>
					</c:if>
				</tbody>
			</table>
