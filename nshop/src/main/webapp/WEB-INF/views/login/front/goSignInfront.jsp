...
<%-- 			<span class="title"><a href="javascript:movePage('front/product/list')" class="title"><spring:message code="label.member.join.title" /></a></span> --%>
			</h1>
			...
			<fieldset class="loginBox">
				<table class="amb_form_table lineAll">
					...
					<!-- 태어난년도를 위한 동적 select -->
							...
							<tr>
								...
								<td>
									<input type="number" class="inp" style="width: 100%;" id="tel_no" name="tel_no" placeholder='<spring:message code="label.member.join.telno"/>' maxlength="11" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}" autofocus onfocus="this.value = this.value;" value="" />
								</td>
							</tr>
							<tr>
				...
				<div class="loginBtn">
					<a href="javascript:movePage('/front/product/list');" class="amb_btnstyle gray large" style="width:48%;"><spring:message code="label.order.status.cancel" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="javascript:goJoin();" class="amb_btnstyle red large" style="width:48%;"><spring:message code="label.member.join.joinlabel" /></a>
