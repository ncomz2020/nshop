...
function isValid(){
	...
	//전화번호, 휴대번호 정규식 체크
	if($("#usr_tel_no").val()!=null && $("#usr_tel_no").val()!=""){
			...
			<table class="amb_form_table lineAll" >	
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" class="inp" style="width:30%;" id="usr_tel_no" name="usr_tel_no" maxlength="11" placeholder='<spring:message code="label.member.join.telno"/>' /></td>
					</tr>
					<tr>
